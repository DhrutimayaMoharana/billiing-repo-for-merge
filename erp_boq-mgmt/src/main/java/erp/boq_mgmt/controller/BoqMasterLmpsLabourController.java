...
@RequestMapping(value = "/boq_master_lmps_labour")
@RestController
@CrossOrigin
public class BoqMasterLmpsLabourController {
	...
	@Autowired
	private BoqMasterLmpsLabourService boqMasterLmpsLabourService;
	...
	public ResponseEntity<?> addBoqMasterLmpsLabour(
			@RequestBody(required = true) BoqMasterLmpsLabourAddUpdateRequest requestDTO, HttpServletRequest request)
			throws Exception {
		...
		CustomResponse response = validate.addBoqMasterLmpsLabour(requestDTO);
		...
		if (response.getStatus().equals(Responses.SUCCESS.getCode()))
			...
			response = boqMasterLmpsLabourService.addBoqMasterLmpsLabour(requestDTO);
	...
	public ResponseEntity<?> updateBoqMasterLmpsLabour(
			@RequestBody(required = true) BoqMasterLmpsLabourAddUpdateRequest requestDTO, HttpServletRequest request)
			throws Exception {
		...
		CustomResponse response = validate.updateBoqMasterLmpsLabour(requestDTO);
		if (response.getStatus().equals(HttpStatus.OK.value())) {
		...
		if (response.getStatus().equals(Responses.SUCCESS.getCode()))
			response = boqMasterLmpsLabourService.updateBoqMasterLmpsLabour(requestDTO);
	...
	public ResponseEntity<?> getBoqMasterLmpsLabourByBoqMasterLmpsId(
		...
		if (response.getStatus().equals(Responses.SUCCESS.getCode()))
			response = boqMasterLmpsLabourService.getBoqMasterLmpsLabourByBoqMasterLmpsId(boqMasterLmpsId);
	...
	public ResponseEntity<?> deactivateBoqMasterLmpsLabour(
			@RequestBody(required = true) BoqMasterLmpsLabourDeactivateRequest requestDTO, HttpServletRequest request)
			throws Exception {
		...
		if (response.getStatus().equals(Responses.SUCCESS.getCode()))
			response = boqMasterLmpsLabourService.deactivateBoqMasterLmpsLabour(requestDTO);
