...
public class BoqCostDefinitionUpdateRequest {
	...
	public BoqCostDefinitionUpdateRequest() {
		super();
	}

	public BoqCostDefinitionUpdateRequest(Long id, Long boqId, Double expectedOutputValue, Boolean foamworkIncluded,
