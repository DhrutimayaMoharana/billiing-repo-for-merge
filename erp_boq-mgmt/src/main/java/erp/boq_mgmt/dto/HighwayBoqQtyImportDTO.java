...
public class HighwayBoqQtyImportDTO {
	...
	public HighwayBoqQtyImportDTO() {
		super();
	}

	public HighwayBoqQtyImportDTO(String code, String standardBookCode, String description, String vendorDescription,
