...
public class GenericBoqQtyImportMapDTO {
	...
	public GenericBoqQtyImportMapDTO() {
		super();
	}

	public GenericBoqQtyImportMapDTO(String code, String standardBookCode, String description, String vendorDescription,
