...
public class UndefinedMasterLmpsBoqItemResponse {
	...
	public UndefinedMasterLmpsBoqItemResponse() {
		super();
	}

	public UndefinedMasterLmpsBoqItemResponse(Long id, String code, String standardBookCode, String name,
