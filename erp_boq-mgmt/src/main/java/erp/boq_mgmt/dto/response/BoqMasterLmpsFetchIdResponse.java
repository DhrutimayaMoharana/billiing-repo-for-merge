...
public class BoqMasterLmpsFetchIdResponse {
	...
	public BoqMasterLmpsFetchIdResponse() {
		super();
	}

	public BoqMasterLmpsFetchIdResponse(Long id, Long boqId, String standardBoqCode, String boqCode,
			String boqName, String categoryName, Integer unitId, String unitName, Double expectedOutputValue,
			Boolean foamworkIncluded, Double foamworkPercentValue, Boolean overheadIncluded,
			Double overheadPercentValue, Boolean contractorProfitIncluded, Double contractorProfitPercentValue,
			Double extraExpenseAmount, String extraExpenseRemark, Double cost, Integer stateId, String stateName) {
		super();
		this.id = id;
		this.boqId = boqId;
