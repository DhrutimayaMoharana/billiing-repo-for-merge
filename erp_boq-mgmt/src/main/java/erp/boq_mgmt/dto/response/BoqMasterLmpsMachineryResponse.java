...
public class BoqMasterLmpsMachineryResponse {
	...
	private String siteVariableName;
	...
	public BoqMasterLmpsMachineryResponse() {
		super();
	}

	public BoqMasterLmpsMachineryResponse(Long id, Long boqCostDefinitionId, Long machineryCategoryId,
			String machineryCategoryName, Integer machineryTripId, MachineryTrip machineryTrip, Integer unitId,
			String unitName, Integer siteVariableId, String siteVariableName, Integer afterUnitId, String afterUnitName,
		...
		this.siteVariableName = siteVariableName;
	...
	public String getSiteVariableName() {
		return siteVariableName;
	}

	public void setSiteVariableName(String siteVariableName) {
		this.siteVariableName = siteVariableName;
	}
