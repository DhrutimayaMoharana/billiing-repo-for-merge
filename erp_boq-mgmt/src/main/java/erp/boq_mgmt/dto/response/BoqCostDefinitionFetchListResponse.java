...
public class BoqCostDefinitionFetchListResponse {
	...
	public BoqCostDefinitionFetchListResponse() {
		super();
	}

	public BoqCostDefinitionFetchListResponse(Long id, Long boqId, String boqCode, String boqName,
