...
public class WorkLayerBoqsFetchResponse {
	...
	public WorkLayerBoqsFetchResponse() {
		super();
	}

	public WorkLayerBoqsFetchResponse(Integer id, String code, String name, String description, Set<Long> boqItemIds,
