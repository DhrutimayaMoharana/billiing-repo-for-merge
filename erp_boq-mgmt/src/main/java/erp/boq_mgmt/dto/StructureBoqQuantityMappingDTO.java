...
public class StructureBoqQuantityMappingDTO {
	...
	public StructureBoqQuantityMappingDTO(Long id, StructureDTO structure, String description, String vendorDescription,
			UnitDTO unit, BoqItemDTO boq, CategoryItemDTO category, SubcategoryItemDTO subcategory, Long siteId,
			Double quantity, Double rate, Double maxRate, String remark, FileDTO file, Integer version,
			Integer quantityVersion, Date modifiedOn, Long modifiedBy, Boolean isActive, Integer companyId) {
		super();
		this.id = id;
