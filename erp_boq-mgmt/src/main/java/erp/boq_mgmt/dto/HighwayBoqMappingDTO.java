...
public class HighwayBoqMappingDTO {
	...
	public HighwayBoqMappingDTO(Long id, BoqItemDTO boq, String description, String vendorDescription, CategoryItemDTO category,
			SubcategoryItemDTO subcategory, Double quantity, Double rate, Double maxRate, String remark, Long siteId, FileDTO file, Integer version,
