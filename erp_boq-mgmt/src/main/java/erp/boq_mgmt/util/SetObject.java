...
import erp.boq_mgmt.dto.BorewellBoqParentChildDTO;
import erp.boq_mgmt.dto.BorewellBoqsRenderDTO;
...
import erp.boq_mgmt.dto.ChainageBorewellBoqQuantityMappingDTO;
...
import erp.boq_mgmt.dto.GenericBoqParentChildDTO;
...
//		String encodedBase64File = utilityService.getFileS3EncodedBase64(obj.getId());
	...
	public BorewellBoqTransac BorewellBoqEntityMappingToTransac(BorewellBoqMapping obj) {
		if (obj == null)
			return null;
		return new BorewellBoqTransac(null, obj.getBoq().getId(), obj.getDescription(), obj.getDescription(),
				obj.getCategory() != null ? obj.getCategory().getId() : null,
				obj.getSubcategory() != null ? obj.getSubcategory().getId() : null, obj.getRate(), obj.getMaxRate(),
				obj.getQuantity(), obj.getIsActive(), obj.getRemark(), obj.getSiteId(), obj.getFile().getId(),
				obj.getVersion(), obj.getQuantityVersion(), new Date(), obj.getModifiedBy(), obj.getCompanyId());
	...
	public GenericBoqMappingDTO boqCategoryMapEntityToDto(GenericBoqMappingHighway obj) {
		if (obj == null)
			return null;
		return new GenericBoqMappingDTO(obj.getId(), obj.getWorkorderTypeId(), obj.getWorkorderTypeName(),
				boqItemEntityToDto(obj.getBoq()), obj.getDescription(), obj.getVendorDescription(),
				categoryItemEntityToDto(obj.getCategory()), subcategoryItemEntityToDto(obj.getSubcategory()),
				obj.getQuantity(), obj.getRate(), obj.getMaxRate(), obj.getRemark(), obj.getSiteId(),
				fileEntityToDto(obj.getFile()), obj.getVersion(), obj.getQuantityVersion(), obj.getIsActive(),
				obj.getModifiedOn(), obj.getModifiedBy(), obj.getCompanyId());
	}

	public BorewellBoqMappingDTO boqCategoryMapEntityToDto(BorewellBoqMapping obj) {
		if (obj == null)
			return null;
		return new BorewellBoqMappingDTO(obj.getId(), boqItemEntityToDto(obj.getBoq()), obj.getDescription(),
				obj.getVendorDescription(), categoryItemEntityToDto(obj.getCategory()),
				subcategoryItemEntityToDto(obj.getSubcategory()), obj.getQuantity(), obj.getRate(), obj.getMaxRate(),
				obj.getRemark(), obj.getSiteId(), fileEntityToDto(obj.getFile()), obj.getVersion(),
				obj.getQuantityVersion(), obj.getIsActive(), obj.getModifiedOn(), obj.getModifiedBy(),
	...
	public GenericBoqMappingHighway boqCategoryMapDtoToEntity(GenericBoqMappingDTO obj) {
		if (obj == null)
			return null;
		return new GenericBoqMappingHighway(obj.getId(), obj.getWorkorderTypeId(), null,
				boqItemDtoToEntity(obj.getBoq()), obj.getDescription(), obj.getVendorDescription(),
				categoryItemDtoToEntity(obj.getCategory()), subcategoryItemDtoToEntity(obj.getSubcategory()),
				obj.getQuantity(), obj.getRate(), obj.getMaxRate(), obj.getRemark(), obj.getSiteId(),
				fileDtoToEntity(obj.getFile()), obj.getVersion(), obj.getQuantityVersion(), obj.getIsActive(),
				obj.getModifiedOn(), obj.getModifiedBy(), obj.getCompanyId());
	}

	public BorewellBoqMapping boqCategoryMapDtoToEntity(BorewellBoqMappingDTO obj) {
		if (obj == null)
			return null;
		return new BorewellBoqMapping(obj.getId(), boqItemDtoToEntity(obj.getBoq()), obj.getDescription(),
				obj.getVendorDescription(), categoryItemDtoToEntity(obj.getCategory()),
				subcategoryItemDtoToEntity(obj.getSubcategory()), obj.getQuantity(), obj.getRate(), obj.getMaxRate(),
				obj.getRemark(), obj.getSiteId(), fileDtoToEntity(obj.getFile()), obj.getVersion(),
				obj.getQuantityVersion(), obj.getIsActive(), obj.getModifiedOn(), obj.getModifiedBy(),
	...
	public GenericChainageBoqQuantityMapping chainageBoqQtyMapDtoToEntity(ChainageGenericBoqQuantityMappingDTO obj) {
		if (obj == null)
			return null;
		return new GenericChainageBoqQuantityMapping(obj.getId(), chainageDtoToEntity(obj.getChainage()),
				boqItemDtoToEntity(obj.getBoq()), boqCategoryMapDtoToEntity(obj.getGenericBoq()), obj.getSiteId(),
				obj.getLhsQuantity(), obj.getRhsQuantity(), obj.getStructureRemark(), obj.getIsActive(),
				obj.getModifiedOn(), obj.getModifiedBy(), obj.getCompanyId());
	}

	public ChainageBorewellBoqQuantityMapping chainageBoqQtyMapDtoToEntity(ChainageBorewellBoqQuantityMappingDTO obj) {
		if (obj == null)
			return null;
		return new ChainageBorewellBoqQuantityMapping(obj.getId(), chainageDtoToEntity(obj.getChainage()),
				boqItemDtoToEntity(obj.getBoq()), boqCategoryMapDtoToEntity(obj.getBorewellBoq()), obj.getSiteId(),
				obj.getLhsQuantity(), obj.getRhsQuantity(), obj.getStructureRemark(), obj.getIsActive(),
				obj.getModifiedOn(), obj.getModifiedBy(), obj.getCompanyId());
	}

	public ChainageGenericBoqQuantityMappingDTO chainageBoqQtyMapEntityToDto(GenericChainageBoqQuantityMapping obj) {
		if (obj == null)
			return null;
		return new ChainageGenericBoqQuantityMappingDTO(obj.getId(), chainageEntityToDto(obj.getChainage()),
				boqItemEntityToDto(obj.getBoq()), boqCategoryMapEntityToDto(obj.getGenericBoq()), obj.getSiteId(),
				obj.getLhsQuantity(), obj.getRhsQuantity(), obj.getStructureRemark(), obj.getIsActive(),
				obj.getModifiedOn(), obj.getModifiedBy(), obj.getCompanyId());
	}
	...
	public ChainageBorewellBoqQuantityMappingDTO chainageBoqQtyMapEntityToDto(ChainageBorewellBoqQuantityMapping obj) {
		if (obj == null)
			return null;
		return new ChainageBorewellBoqQuantityMappingDTO(obj.getId(), chainageEntityToDto(obj.getChainage()),
				boqItemEntityToDto(obj.getBoq()), boqCategoryMapEntityToDto(obj.getBorewellBoq()), obj.getSiteId(),
				obj.getLhsQuantity(), obj.getRhsQuantity(), obj.getStructureRemark(), obj.getIsActive(),
				obj.getModifiedOn(), obj.getModifiedBy(), obj.getCompanyId());
	}
	...
	public ChainageBorewellBoqQuantityTransacs cbqEntityMappingToTransac(ChainageBorewellBoqQuantityMapping obj) {
		if (obj == null)
			return null;
		return new ChainageBorewellBoqQuantityTransacs(null, obj.getChainage().getId(), obj.getBoq().getId(),
				obj.getBorewellBoq().getId(), obj.getSiteId(), obj.getLhsQuantity(), obj.getRhsQuantity(),
				obj.getStructureRemark(), obj.getIsActive(), obj.getModifiedOn(), obj.getModifiedBy(),
				obj.getCompanyId());
	}
...
//						result.getCategory() : categoryItemDtoToEntity(obj.getCategory()));
	...
	public GenericChainageBoqQuantityMapping updatedCbq(GenericChainageBoqQuantityMapping result,
			GenericChainageBoqQuantityMapping obj) {
		...
		result.setChainage(obj.getChainage().getId().equals(result.getChainage().getId()) ? result.getChainage()
				: obj.getChainage());
		result.setBoq(obj.getBoq().getId().equals(result.getBoq().getId()) ? result.getBoq() : obj.getBoq());
		result.setGenericBoq(obj.getGenericBoq().getId().equals(result.getGenericBoq().getId()) ? result.getGenericBoq()
				: obj.getGenericBoq());
		result.setSiteId(obj.getSiteId());
		result.setLhsQuantity(obj.getLhsQuantity());
		result.setRhsQuantity(obj.getRhsQuantity());
	...
	public ChainageBorewellBoqQuantityMapping updatedCbq(ChainageBorewellBoqQuantityMapping result,
			ChainageBorewellBoqQuantityMapping obj) {
		...
		result.setChainage(obj.getChainage().getId().equals(result.getChainage().getId()) ? result.getChainage()
				: obj.getChainage());
		result.setBoq(obj.getBoq().getId().equals(result.getBoq().getId()) ? result.getBoq() : obj.getBoq());
		result.setBorewellBoq(
				obj.getBorewellBoq().getId().equals(result.getBorewellBoq().getId()) ? result.getBorewellBoq()
						: obj.getBorewellBoq());
		result.setSiteId(obj.getSiteId());
		result.setLhsQuantity(obj.getLhsQuantity());
		result.setRhsQuantity(obj.getRhsQuantity());
...
//		result.setStandardBookCode(obj.getStandardBookCode());
	...
	public GenericBoqMappingHighway updatedBoqCategoryMapping(GenericBoqMappingHighway result,
			GenericBoqMappingHighway obj) {

		if (result == null || obj == null)
			return null;
		result.setBoq(obj.getBoq().getId().equals(result.getBoq().getId()) ? result.getBoq() : obj.getBoq());
		result.setWorkorderTypeId(obj.getWorkorderTypeId());
		result.setWorkorderTypeName(obj.getWorkorderTypeName());
		result.setSubcategory(obj.getSubcategory() != null && result.getSubcategory() != null
				&& obj.getSubcategory().getId().equals(result.getSubcategory().getId()) ? result.getSubcategory()
						: obj.getSubcategory());
		result.setCategory(obj.getCategory() != null && result.getCategory() != null
	...
	public BorewellBoqMapping updatedBoqCategoryMapping(BorewellBoqMapping result, BorewellBoqMapping obj) {
	...
	public BorewellBoqsRenderDTO renderChildParentBorewellBoqs(List<BorewellBoqMappingDTO> highwayBoqList,
			List<CategoryItemDTO> categories) {

		List<BorewellBoqParentChildDTO> resultList = new ArrayList<>();
		int uniquePid = 0;
		Double totalAmount = 0.0;
		BorewellBoqsRenderDTO result = new BorewellBoqsRenderDTO(resultList, totalAmount);
		Set<String> uniqueCategories = new HashSet<>();
		for (BorewellBoqMappingDTO highBoq : highwayBoqList) {
			if (highBoq.getCategory() != null && highBoq.getCategory().getName() != null) {
				uniqueCategories.add(highBoq.getCategory().getName());
			}
		}
		for (String categoryName : uniqueCategories) {
			++uniquePid;
			List<BorewellBoqMappingDTO> categoryData = new ArrayList<>();
			for (BorewellBoqMappingDTO highBoq : highwayBoqList) {
				if (highBoq.getCategory() != null && highBoq.getCategory().getName() != null
						&& highBoq.getCategory().getName().equals(categoryName)) {
					categoryData.add(highBoq);
			...
			if (categoryData != null && categoryData.size() > 0) {
				...
				Boolean isStructureCategory = category.getOfStructure();
				Double parentAmount = 0.0;
				BorewellBoqParentChildDTO parentDTO = new BorewellBoqParentChildDTO(category.getId(),
						categoryData.get(0).getId(), category.getName(), category.getName(), category.getName(), null,
						null, null, false, category.getCode(), category.getStandardBookCode(), null, null, null,
						parentAmount, null, ItemType.Category.toString(), null, uniquePid, null);
				int catPid = uniquePid;
				for (BorewellBoqMappingDTO obj : categoryData) {
					if (obj.getSubcategory() == null) {
						BoqItemDTO boq = obj.getBoq();
						Double amount = obj.getRate() * obj.getQuantity();
						int boqPid = ++uniquePid;
						...
						BorewellBoqParentChildDTO childDTO = new BorewellBoqParentChildDTO(boq.getId(), obj.getId(),
								boq.getName(), obj.getDescription(), obj.getVendorDescription(), boq.getUnit().getId(),
								boq.getUnit().getName(), unitTypeName, isImportable && !isStructureCategory,
								boq.getCode(), boq.getStandardBookCode(), obj.getRate(), obj.getMaxRate(),
								obj.getQuantity(), amount, obj.getRemark(), ItemType.Boq.toString(),
				...
				for (String subcategoryName : uniqueSubcategories) {
					List<BorewellBoqMappingDTO> subcategoryData = new ArrayList<>();
					for (BorewellBoqMappingDTO highBoq : categoryData) {
						if (highBoq.getSubcategory() != null && highBoq.getSubcategory().getName() != null
								&& highBoq.getSubcategory().getName().equals(subcategoryName)) {
							subcategoryData.add(highBoq);
						}
					...
					if (subcategoryData != null && subcategoryData.size() > 0) {
						...
						Double subparentAmount = 0.0;
						int subcatPid = ++uniquePid;
						BorewellBoqParentChildDTO subparentDTO = new BorewellBoqParentChildDTO(subcategory.getId(),
								subcategoryData.get(0).getId(), subcategory.getName(), subcategory.getName(),
								subcategory.getName(), null, null, null, false, subcategory.getCode(),
								subcategory.getStandardBookCode(), null, null, null, subparentAmount, null,
								ItemType.Subcategory.toString(), ItemType.Category.toString(), subcatPid, catPid);
						for (BorewellBoqMappingDTO obj : subcategoryData) {
							if (obj.getBoq() != null) {
								BoqItemDTO boq = obj.getBoq();
								Double amount = obj.getRate() * obj.getQuantity();
								int boqPid = ++uniquePid;
								...
								BorewellBoqParentChildDTO childDTO = new BorewellBoqParentChildDTO(boq.getId(),
										obj.getId(), boq.getName(), obj.getDescription(), obj.getVendorDescription(),
										boq.getUnit().getId(), boq.getUnit().getName(), unitTypeName,
										isImportable && !isStructureCategory, boq.getCode(), boq.getStandardBookCode(),
										obj.getRate(), obj.getMaxRate(), obj.getQuantity(), amount, obj.getRemark(),
		...
		if (categories != null && categories.size() > 0) {
			List<BorewellBoqParentChildDTO> resultListSorted = new ArrayList<>();
			List<BorewellBoqParentChildDTO> categoryBoqs = new ArrayList<>();
			for (CategoryItemDTO category : categories) {
				String code = category.getCode();
				if (code != null) {
					for (BorewellBoqParentChildDTO hbm : resultList) {
						if (hbm.getCode() != null && hbm.getCode().toLowerCase().startsWith(code.toLowerCase())) {
							categoryBoqs.add(hbm);
						}
					}
					categoryBoqs.sort(Comparator.comparing(BorewellBoqParentChildDTO::getCode));
					resultListSorted.addAll(resultListSorted);
				}
			}
			for (BorewellBoqParentChildDTO obj1 : resultList) {
				boolean isPresent = false;
				for (BorewellBoqParentChildDTO obj2 : resultListSorted) {
					if (obj1.getPid().equals(obj2.getPid())) {
						isPresent = true;
						break;
					}
	...
	public GenericBoqsRenderDTO renderChildParentGenericBoqs(List<GenericBoqMappingDTO> genericBoqList,
			List<CategoryItemDTO> categories) {

		List<GenericBoqParentChildDTO> resultList = new ArrayList<>();
		int uniquePid = 0;
		Double totalAmount = 0.0;
		GenericBoqsRenderDTO result = new GenericBoqsRenderDTO(resultList, totalAmount);
		Set<String> uniqueCategories = new HashSet<>();
		for (GenericBoqMappingDTO highBoq : genericBoqList) {
			if (highBoq.getCategory() != null && highBoq.getCategory().getName() != null) {
				uniqueCategories.add(highBoq.getCategory().getName());
			}
		}
		for (String categoryName : uniqueCategories) {
			++uniquePid;
			List<GenericBoqMappingDTO> categoryData = new ArrayList<>();
			for (GenericBoqMappingDTO highBoq : genericBoqList) {
				if (highBoq.getCategory() != null && highBoq.getCategory().getName() != null
						&& highBoq.getCategory().getName().equals(categoryName)) {
					categoryData.add(highBoq);
			...
			if (categoryData != null && categoryData.size() > 0) {
				...
				Boolean isStructureCategory = category.getOfStructure();
				Double parentAmount = 0.0;
				GenericBoqParentChildDTO parentDTO = new GenericBoqParentChildDTO(category.getId(),
						categoryData.get(0).getId(), category.getName(), category.getName(), category.getName(), null,
						null, null, false, category.getCode(), category.getStandardBookCode(), null, null, null,
						parentAmount, null, ItemType.Category.toString(), null, uniquePid, null);
				int catPid = uniquePid;
				for (GenericBoqMappingDTO obj : categoryData) {
					if (obj.getSubcategory() == null) {
						BoqItemDTO boq = obj.getBoq();
						Double amount = obj.getRate() * obj.getQuantity();
						int boqPid = ++uniquePid;
						...
						GenericBoqParentChildDTO childDTO = new GenericBoqParentChildDTO(boq.getId(), obj.getId(),
								boq.getName(), obj.getDescription(), obj.getVendorDescription(), boq.getUnit().getId(),
								boq.getUnit().getName(), unitTypeName, isImportable && !isStructureCategory,
								boq.getCode(), boq.getStandardBookCode(), obj.getRate(), obj.getMaxRate(),
								obj.getQuantity(), amount, obj.getRemark(), ItemType.Boq.toString(),
				...
				for (String subcategoryName : uniqueSubcategories) {
					List<GenericBoqMappingDTO> subcategoryData = new ArrayList<>();
					for (GenericBoqMappingDTO highBoq : categoryData) {
						if (highBoq.getSubcategory() != null && highBoq.getSubcategory().getName() != null
								&& highBoq.getSubcategory().getName().equals(subcategoryName)) {
							subcategoryData.add(highBoq);
						}
					...
					if (subcategoryData != null && subcategoryData.size() > 0) {
						...
						Double subparentAmount = 0.0;
						int subcatPid = ++uniquePid;
						GenericBoqParentChildDTO subparentDTO = new GenericBoqParentChildDTO(subcategory.getId(),
								subcategoryData.get(0).getId(), subcategory.getName(), subcategory.getName(),
								subcategory.getName(), null, null, null, false, subcategory.getCode(),
								subcategory.getStandardBookCode(), null, null, null, subparentAmount, null,
								ItemType.Subcategory.toString(), ItemType.Category.toString(), subcatPid, catPid);
						for (GenericBoqMappingDTO obj : subcategoryData) {
							if (obj.getBoq() != null) {
								BoqItemDTO boq = obj.getBoq();
								Double amount = obj.getRate() * obj.getQuantity();
								int boqPid = ++uniquePid;
								...
								GenericBoqParentChildDTO childDTO = new GenericBoqParentChildDTO(boq.getId(),
										obj.getId(), boq.getName(), obj.getDescription(), obj.getVendorDescription(),
										boq.getUnit().getId(), boq.getUnit().getName(), unitTypeName,
										isImportable && !isStructureCategory, boq.getCode(), boq.getStandardBookCode(),
										obj.getRate(), obj.getMaxRate(), obj.getQuantity(), amount, obj.getRemark(),
		...
		if (categories != null && categories.size() > 0) {
			List<GenericBoqParentChildDTO> resultListSorted = new ArrayList<>();
			List<GenericBoqParentChildDTO> categoryBoqs = new ArrayList<>();
			for (CategoryItemDTO category : categories) {
				String code = category.getCode();
				if (code != null) {
					for (GenericBoqParentChildDTO hbm : resultList) {
						if (hbm.getCode() != null && hbm.getCode().toLowerCase().startsWith(code.toLowerCase())) {
							categoryBoqs.add(hbm);
						}
					}
					categoryBoqs.sort(Comparator.comparing(GenericBoqParentChildDTO::getCode));
					resultListSorted.addAll(resultListSorted);
				}
			}
			for (GenericBoqParentChildDTO obj1 : resultList) {
				boolean isPresent = false;
				for (GenericBoqParentChildDTO obj2 : resultListSorted) {
					if (obj1.getPid().equals(obj2.getPid())) {
						isPresent = true;
						break;
					}
