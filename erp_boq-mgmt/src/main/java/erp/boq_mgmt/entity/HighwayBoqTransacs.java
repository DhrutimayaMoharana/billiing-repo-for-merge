...
@Entity
@Table(name = "highway_boq_transacs")
public class HighwayBoqTransacs implements Serializable {
	...
	public HighwayBoqTransacs() {
		super();
	}

	public HighwayBoqTransacs(Long id, Long boqId, String description, String vendorDescription, Long categoryId,
	...
	public HighwayBoqTransacs(Long id) {
		super();
		this.id = id;
	}
