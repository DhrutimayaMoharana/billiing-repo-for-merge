...
@Entity
@Table(name = "boq_master_lmps_materials")
public class BoqMasterLmpsMaterial {
	...
	public BoqMasterLmpsMaterial() {
		super();
	}

	public BoqMasterLmpsMaterial(Long id, Long boqMasterLmpsId, Integer materialId, Integer unitId, Double quantity,
