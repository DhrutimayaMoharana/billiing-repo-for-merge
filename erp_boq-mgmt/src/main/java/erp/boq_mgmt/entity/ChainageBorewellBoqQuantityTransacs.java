...
@Entity
@Table(name = "chainage_borewell_boq_qty_transacs")
public class ChainageBorewellBoqQuantityTransacs implements Serializable {

	private static final long serialVersionUID = -6283349503012074539L;
	...
	public ChainageBorewellBoqQuantityTransacs() {
		super();
	}

	public ChainageBorewellBoqQuantityTransacs(Long id) {
		super();
		this.id = id;
	}

	public ChainageBorewellBoqQuantityTransacs(Long id, Long chainageId, Long boqId, Long borewellBoqId, Long siteId,
