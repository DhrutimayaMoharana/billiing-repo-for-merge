...
public class WorkorderHiringMachineRateDetails {
	...
	private WorkorderHiringMachineWorkItemMapping machineItem;
	...
	@OneToOne
	@JoinColumn(name = "wo_hiring_machine_item_id", insertable = false, updatable = false)
	public WorkorderHiringMachineWorkItemMapping getMachineItem() {
		return machineItem;
	}

	public void setMachineItem(WorkorderHiringMachineWorkItemMapping machineItem) {
