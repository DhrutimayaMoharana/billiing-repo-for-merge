...
public class BillDeductionMappingV2 implements Serializable {
	...
	public BillDeductionMappingV2() {
		super();
	}

	public BillDeductionMappingV2(Long id, Long billId, Integer workorderBillInfoId, Integer billDeductionId,
