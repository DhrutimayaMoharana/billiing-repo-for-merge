...
import erp.billing.feignClient.WorkflowEngineClient;
...
public class WorkflowEngineService {
	...
	public List<StateTransitionDTO> getStateTransition(Integer entityId, Long siteId, Integer stateId, Integer roleId,
			Integer companyId) {
		try {
			CustomResponse response = workflowEngineClient.getStateTransition(entityId, siteId.intValue(), stateId,
					roleId, companyId, ENGINE_TOKEN);
