...
public interface WorkorderBoqWorkDao {
	...
	List<ChainageBorewellBoqQuantityMapping> fetchActiveCbqsByChainageIdsAndSiteIdV1(Set<Long> chainageIds,
			Long siteId);
	...
	List<GenericChainageBoqQuantityMapping> fetchActiveCbqsBetweenChainageNumericValuesAndSiteIdAndWoCategoriesV1(
			Integer fromChainageValue, Integer toChainageValue, Set<Long> woCategoryIds, Long siteId, Integer woTypeId);
...
//	Long saveWorkorderBoqWork(WorkorderBoqWorkHighway boqWork);
...
//	Boolean updateWorkorderBoqWork(WorkorderBoqWorkHighway savedBoqWork);
	...
	List<BorewellBoqMapping> fetchBorewellBoqQtysByBoqId(Long siteId, Long boqId);

	List<GenericBoqMappingHighway> fetchGenericBoqQtysByBoqId(Long siteId, Long boqId, Integer woTypeId);
...
//	WorkorderBoqWorkHighway fetchWorkorderBoqWorkByWorkorderIdV1(Long workorderId);
