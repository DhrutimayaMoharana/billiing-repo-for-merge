...
// 					BreakdownHours Check
				...
				if (shift != null && attendanceStatus != null && stringBreakdownHours != null) {
					Boolean validBreakdownHours = false;
					if (attendanceStatus.equals(MachineryAttendanceStatus.PRESENT) && breakdownHours <= 12
							&& breakdownHours >= 0) {
						validBreakdownHours = true;
					} else if (attendanceStatus.equals(MachineryAttendanceStatus.HALFDAY) && breakdownHours <= 6
							&& breakdownHours >= 0) {
						validBreakdownHours = true;
					}
