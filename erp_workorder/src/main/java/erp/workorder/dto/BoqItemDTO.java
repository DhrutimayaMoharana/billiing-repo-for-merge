...
public class BoqItemDTO {
	...
	public BoqItemDTO(Long id, String code, String standardBookCode, String name, String vendorDescription, UnitDTO unit, CategoryItemDTO category,
			SubcategoryItemDTO subcategory, Boolean isActive, Date createdOn, Long createdBy,
