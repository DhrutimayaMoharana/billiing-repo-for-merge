...
public class WorkorderHiringMachineWorkItemGetResponse {
	...
	private WorkShiftScheduleResponse scheduleResponse;
	...
	public WorkorderHiringMachineWorkItemGetResponse(Long hmWorkItemId, String description, Long machineCatgeoryId,
			...
			WorkShiftScheduleResponse scheduleResponse) {
		super();
	...
	public WorkShiftScheduleResponse getScheduleResponse() {
		return scheduleResponse;
	}

	public void setScheduleResponse(WorkShiftScheduleResponse scheduleResponse) {
		this.scheduleResponse = scheduleResponse;
	}
