...
public class WorkorderCloseDeactivateRequest {
	...
	public WorkorderCloseDeactivateRequest() {
		super();
	}

	public WorkorderCloseDeactivateRequest(Long workorderCloseId, Long siteId, UserDetail userDetail) {
		super();
