...
public class WorkorderBoqWorkQtyMappingDTO {
	...
	public WorkorderBoqWorkQtyMappingDTO(Long id, Long structureTypeId, Long structureId, BoqItemDTO boq, UnitDTO unit,
			String description, String vendorDescription, Double rate, Double quantity, Boolean isActive, String remark,
			Boolean isBoqEditable, Integer version, Date modifiedOn, Long modifiedBy) {
		super();
		this.id = id;
