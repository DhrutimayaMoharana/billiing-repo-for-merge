...
@Entity
@Table(name = "wo_consultant_work_versions")
public class WorkorderConsultantWorkVersion implements Serializable {
	...
	public WorkorderConsultantWorkVersion() {
		super();
	}

	public WorkorderConsultantWorkVersion(Long id) {
		super();
		this.id = id;
	}

	public WorkorderConsultantWorkVersion(Long id, Long workorderVersionId, String workScope, String annexureNote,
