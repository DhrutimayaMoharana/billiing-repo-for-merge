...
@Entity
@Table(name = "wo_labour_work")
public class WorkorderLabourWork implements Serializable {

	private static final long serialVersionUID = 1869409326457101283L;
	...
	public WorkorderLabourWork() {
		super();
	}

	public WorkorderLabourWork(Long id) {
		super();
		this.id = id;
	}

	public WorkorderLabourWork(Long id, Long workorderId, String workScope, String annexureNote, Boolean isActive,
