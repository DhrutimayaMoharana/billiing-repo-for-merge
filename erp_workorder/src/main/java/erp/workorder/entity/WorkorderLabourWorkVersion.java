...
@Entity
@Table(name = "wo_labour_work_version")
public class WorkorderLabourWorkVersion implements Serializable {
	...
	public WorkorderLabourWorkVersion() {
		super();
	}

	public WorkorderLabourWorkVersion(Long id, Long workorderVersionId, String workScope, String annexureNote,
