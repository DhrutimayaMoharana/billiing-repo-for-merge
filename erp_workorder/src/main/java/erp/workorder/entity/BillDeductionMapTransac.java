...
public class BillDeductionMapTransac implements Serializable {
	...
	public BillDeductionMapTransac(Long id, Long billId, Integer workorderBillInfoId, Integer billDeductionId,
			Boolean isPercentage, Double value, Boolean isActive, Date createdOn, Long createdBy) {
		super();
		this.id = id;
		this.billId = billId;
