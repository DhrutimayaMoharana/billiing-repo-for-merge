...
@Entity
@Table(name = "wo_hiring_machine_work_version")
public class WorkorderHiringMachineWorkVersion implements Serializable {
	...
	public WorkorderHiringMachineWorkVersion() {
		super();
	}

	public WorkorderHiringMachineWorkVersion(Long id, Long workorderVersionId, String workScope, String annexureNote,
