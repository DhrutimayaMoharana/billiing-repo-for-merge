...
@Entity
@Table(name = "wo_transportation_work")
public class WorkorderTransportWork implements Serializable {
	...
	public WorkorderTransportWork() {
		super();
	}

	public WorkorderTransportWork(Long id) {
		super();
		this.id = id;
	}

	public WorkorderTransportWork(Long id, Long workorderId, String workScope, String annexureNote, Boolean isActive,
