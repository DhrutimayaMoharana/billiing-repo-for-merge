...
public class EntityStateMap implements Serializable {
	...
	public EntityStateMap(Integer id, Integer entityId, Integer stateId, Integer stateActionId, Boolean isInitial,
			Boolean isFinal, Boolean isNecessary, Boolean isEditable, Boolean isDeletable, Boolean maintainVersion,
			Integer prioritySequence, Integer companyId, Boolean isActive, Date createdOn, Integer createdBy) {
		super();
		this.id = id;
