...
public class WorkorderHiringMachineWorkItemMapping implements Serializable {
	...
	private WorkShiftSchedule shiftSchedule;
	...
	public WorkorderHiringMachineWorkItemMapping(Long id, Long workorderHmWorkId, String description,
			Long machineCatgeoryId, Integer machineCount, Double quantity, Double rate,
			MachineryRunningMode runningMode, UnitMaster unit, Boolean thresholdApplicable, Double thresholdQuantity,
			...
			Date createdOn, Long createdBy, Date modifiedOn, Long modifiedBy, WorkShiftSchedule shiftSchedule) {
		super();
		this.id = id;
	...
	public WorkShiftSchedule getShiftSchedule() {
		return shiftSchedule;
	}

	public void setShiftSchedule(WorkShiftSchedule shiftSchedule) {
		this.shiftSchedule = shiftSchedule;
	}
}
