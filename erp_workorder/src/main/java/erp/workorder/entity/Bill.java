...
public class Bill implements Serializable {
	...
	public Bill(Long id, Integer billNo, Date fromDate, Date toDate, Long workorderId, String taxInvoiceNo,
			Date taxInvoiceDate, Double applicableIgst, Boolean isIgstOnly, EngineState state, Long siteId,
